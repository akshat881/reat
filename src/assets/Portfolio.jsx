    ...
    <div id="grid-gallery" className="container grid-gallery">
        ...
        <section className="grid-wrap">
            <ul className="row grid">
                ...
                <li>
                    <figure>
                        <img src="http://drive.google.com/uc?export=view&id=1v9AZ0PhdzzjQT6N-WR5g1OHTP1b9Tx0p" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="http://drive.google.com/uc?export=view&id=1nRUkOWWLnwF5lt7Ex31f2Vu4_AY__kwh" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="http://drive.google.com/uc?export=view&id=1FGHjBkY3_OMNd_sTgOvdkb5cNF5A67vF" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="http://drive.google.com/uc?export=view&id=1n6rv91tS8op_8uHtg3IecDnCAIpoMK3f" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="http://drive.google.com/uc?export=view&id=1htmVnnxaNgh2mcoD56roaemDGGpk2iFX" alt="Portolio Image" />
                        <div><span>Poster Project</span></div>
                    </figure>
                </li>
                ...
                <li>
                    <figure>
                        <img src="http://drive.google.com/uc?export=view&id=1m0IcRJ3I1eI0rCwzzY9GhGRL7nj30Yt1" alt="Portolio Image" />
                        <div><span>Poster Project</span></div>
                    </figure>
                </li>
                ...
                <li>
                    <figure>
                        <img src="http://drive.google.com/uc?export=view&id=1WSNYgsXSRpm2_HpHdbW7n8jtqJPY4N4K" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="http://drive.google.com/uc?export=view&id=164tKajoIaGpngVoXF6rKWYO26jkFIrH1" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src='http://drive.google.com/uc?export=view&id=1CD9fk2T0-S9oM1loSTqg-g3qElnF_n1X'alt="Portolio Image" />
            ...
            <ul>
                ...
                <li>
                    <figure>
                        ...
                        <img src="http://drive.google.com/uc?export=view&id=1u3-ssEZDlkipvCAFFvfTf_gtspq02yHr" alt="Portolio Image" />
                        ...
                        <div id="slider" className="carousel slide portfolio-slider" data-ride="carousel" data-interval="false">
                            ...
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <img src="http://drive.google.com/uc?export=view&id=1vVug_WFBfKSRItw4_58PQZGPEDm1YIqu" alt="slide 1"/>
                                </div>
                                <div className="carousel-item">
                                    <img src="http://drive.google.com/uc?export=view&id=11G5JfWxGqjss3BSBFZ2D9umq8eYLuOvD" alt="slide 2"/>
                                </div>
                                <div className="carousel-item">
                                    <img src="http://drive.google.com/uc?export=view&id=1ELUZ-Xprdr2rwLyQcrI_U8ES5TEqNaVn" alt="slide 3"/>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <figure>
                        ...
                        <video id="video" className="responsive-video" controls poster="http://drive.google.com/uc?export=view&id=1n6rv91tS8op_8uHtg3IecDnCAIpoMK3f">
                            <source src="http://drive.google.com/uc?export=view&id=1tO6n9wYw4faO12_thHsW56GwNouY8DrH" type="video/mp4"/>
                        </video>
                ...
                <li>
                    <figure>
                        ...
                        <img src="http://drive.google.com/uc?export=view&id=1s8IvgPrEAxwefBygKgmfdjEhgxYTinWe" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        ...
                        <img src="http://drive.google.com/uc?export=view&id=1Lw5N5WoYcQoXknHmUo5ps6AdFob0AC-H" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        ...
                        <img src="http://drive.google.com/uc?export=view&id=1g53oD3POcO66fBtcznny0T9MCZUKivlU" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        ...
                        <img src="http://drive.google.com/uc?export=view&id=1h3LN8WYkTfTYpFpNeBTAEzQ-nEWSCbL6" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        ...
                        <img src="http://drive.google.com/uc?export=view&id=1fyNRp5Ytl8PT_Cr_2C71jTQ-zx1_7Qh9" alt="Portolio Image" />
